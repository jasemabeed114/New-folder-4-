...
"resource": {
  ...
  "rules":[
    [["if",0,1],["add",0]],
    [["if",2,3],["add",1,13,17]],
    [["if",1],["add",2,20,30,32,33,36,56,103]],
    [["if",4,5,6],["add",3,8,26,28,29,34,40,50,52,57,58,102,107,108]],
    [["if",5,7,8],["add",4,19,108]],
    [["if",1,5],["add",5,9,21,47,49,105]],
    [["if",5,9,10],["add",6,18,23,51,61,106,108]],
    [["if",5,11,12],["add",7,108]],
    [["if",13,14],["add",10,14]],
    [["if",3,15],["add",11,15]],
    [["if",3,16],["add",12,16]],
    [["if",5,14,17],["add",22,37,62,108]],
    [["if",5,18,19],["add",24,108]],
    [["if",11,20,21],["add",25]],
    [["if",5,9,22,23],["add",27,31,104,109]],
    [["if",1,24],["add",35]],
    [["if",21,25],["add",37,62]],
    [["if",21,26],["add",38]],
    [["if",3,5,27],["unless",28],["add",39,59,101]],
    [["if",21,29],["add",41]],
    [["if",3,7],["add",42]],
    [["if",3,30],["add",43]],
    [["if",3,9],["add",44]],
    ...
    [["if",3,4],["add",46]],
    [["if",1,5,32],["add",48,60]],
    [["if",1,5,33],["add",53,54,55,110]],
    [["if",34],["add",63]],
    [["if",5,21,35],["add",64,70,75,76,88,94]],
    [["if",5,36,37],["add",65,71,77,78,89,95]],
    [["if",5,37,38],["add",66,72,79,80,90,96]],
    [["if",5,37,39],["add",67,73,81,82,91,97]],
    [["if",5,37,40],["add",68,74,83,85,92,98]],
    [["if",5,37,41],["add",69,84,86,87,93,99]],
    [["if",1,5,42],["add",100]],
    [["if",1,5,43],["add",100]],
    [["if",1,5,44],["add",100]],
    [["if",1,5,45],["add",100]],
...
ib[8]=function(a){if(null==a)return" null ";switch(typeof a){case "boolean":case "number":return" "+a+" ";default:return"'"+String(String(a)).replace(rb,tb)+"'"}};var Bb=/['()]/g,Cb=function(a){return"%"+a.charCodeAt(0).toString(16)};ib[12]=function(a){var b=
...
var Nd=[m.C,m.H],Od=function(a){var b=a[m.pe];b&&Ac(40);var c=a[m.qe];c&&Ac(41);for(var d=xa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==m.pe&&f!==m.qe)if(-1<ya(Nd,f)){var h=f,k=a[f],l=d[e];yd().set(h,k,l,"US","US-VA",c)}else{var n=f,p=a[f],r=d[e];yd().set(n,p,r,"US","US-VA",c);}},Pd=function(a,
...
W.g.f=["google"],function(){(function(a){W.__f=a;W.__f.h="f";W.__f.m=!0;W.__f.priorityOverride=0})(function(a){var b=On("gtm.referrer",1)||D.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?ke(me(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):Nn(String(b)):String(b)})}();W.g.k=["google"],function(){(function(a){W.__k=a;W.__k.h="k";W.__k.m=!0;W.__k.priorityOverride=0})(function(a){return Rn(a.vtp_name,On("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
W.g.baut=["nonGoogleScripts"],function(){var a=!1;(function(b){W.__baut=b;W.__baut.h="baut";W.__baut.m=!0;W.__baut.priorityOverride=0})(function(b){function c(){var k=L(d);if(Array.isArray(k)){var l;try{l=Yc(L("UET"),{ti:b.vtp_tagId,q:k,tm:"gtm001"})}catch(n){}l?(B[d]=l,l.push("pageLoad"),b.vtp_gtmOnSuccess()):F(b.vtp_gtmOnFailure)}else b.vtp_gtmOnSuccess()}var d=b.vtp_uetqName||"uetq",e=L(d,[],!0);if("VARIABLE_REVENUE"==b.vtp_eventType)e.push({gv:b.vtp_goalValue}),
b.vtp_gtmOnSuccess();else if("CUSTOM"==b.vtp_eventType){var f={},h=function(k,l){void 0!==b[k]&&(f[l]=b[k])};h("vtp_goalValue","gv");h("vtp_eventCategory","ec");h("vtp_eventAction","ea");h("vtp_eventLabel","el");h("vtp_eventValue","ev");e.push(f);b.vtp_gtmOnSuccess()}else if(Array.isArray(e))if(a)c();else try{J("https://bat.bing.com/bat.js",function(){a=!0;c()},b.vtp_gtmOnFailure)}catch(k){F(b.vtp_gtmOnFailure)}else b.vtp_gtmOnSuccess()})}();W.g.smm=["google"],function(){(function(a){W.__smm=a;W.__smm.h="smm";W.__smm.m=!0;W.__smm.priorityOverride=0})(function(a){var b=a.vtp_input,c=Eo(a.vtp_map,"key","value")||{},d=c.hasOwnProperty(b)?c[b]:a.vtp_defaultValue;Xn(d,"smm",a.vtp_gtmEventId);return d})}();
...
W.g.img=["customPixels"],function(){(function(a){W.__img=a;W.__img.h="img";W.__img.m=!0;W.__img.priorityOverride=0})(function(a){var b=nd('<a href="'+a.vtp_url+'"></a>')[0].href,c=a.vtp_cacheBusterQueryParam;if(a.vtp_useCacheBuster){c||(c="gtmcb");var d=b.charAt(b.length-1),e=0<=b.indexOf("?")?"?"==d||"&"==d?"":"&":"?";b+=e+c+"="+a.vtp_randomNumber}Co(b,a.vtp_gtmOnSuccess,a.vtp_gtmOnFailure)})}();
